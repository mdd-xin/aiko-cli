<template>
  <UpDownLayout>
    <template #form>
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="子域名">
          <el-input
            v-model="formInline.childname"
            placeholder="子域名"
          ></el-input>
        </el-form-item>
        <el-form-item label="记录值">
          <el-input v-model="formInline.value" placeholder="记录值"></el-input>
        </el-form-item>
        <el-form-item label="类型">
          <el-select v-model="formInline.type" placeholder="类型" class="small">
            <el-option label="区域一" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
          </el-select>
        </el-form-item>
    ...
    <template #btnLeft>
      <el-button type="primary">添加子域名</el-button>
